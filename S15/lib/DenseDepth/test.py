...
from utils import predict, load_images, display_images,saveDepthMapImages,prepareDataSet,saveDataSet
...
#prepareDataSet(outputs.copy(), inputs.copy(),fileName=args.input)
#saveDataSet(start = int(args.rstart), end = int(args.rend),fileName=args.input)
